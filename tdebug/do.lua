...
local tdebug_history = '.tdebug_history'
...
local function loadHistory()
    ...
    local historyFile = io.open(fio.pathjoin(os.getenv("HOME"), tdebug_history),
                                "r")
...
local function banner()
    ...
    local version = tnt.package .. ' ' .. tnt.version

    print(colors.bright("Tarantool Better Shell :: ") .. 
          "tdbg 0.0.1 (c) 2023 Timur Safin\n" .. version)
end
